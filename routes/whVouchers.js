...
function ensureTradingIndexes() {
  ...
  Promise.allSettled([
    ...
    PurchaseVoucher.collection.createIndex({ product_id: 1, warehouse_id: 1, date: -1 }, { name: "trading_purchase_product_date" }),
    SaleVoucher.collection.createIndex({ product_id: 1, warehouse_id: 1, date: -1 }, { name: "trading_sale_product_date" }),
    PurchaseVoucher.collection.createIndex({ farmer_id: 1, warehouse_id: 1, company_account_id: 1, date: -1 }, { name: "trading_purchase_party_filters" }),
    SaleVoucher.collection.createIndex({ buyer_id: 1, warehouse_id: 1, company_account_id: 1, date: -1 }, { name: "trading_sale_buyer_filters" }),
  ]).catch(() => {});
}
