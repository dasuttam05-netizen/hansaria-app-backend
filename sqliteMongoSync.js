...
try {
  ...
  try {
    ...
    const error = new Error(
      'Unable to load the SQLite database module. Tried "./db" and "../db". ' +
      "Please verify the deploy package includes db.js at the project root."
    );
    error.cause = fallbackErr || err;
    throw error;
  }
}
